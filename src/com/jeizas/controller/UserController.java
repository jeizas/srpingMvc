...
import com.jeizas.util.Constants;
import com.jeizas.util.Util;
...
public class UserController {
	...
	public String userLogin(User userModel, Model model){
	...
	public ModelAndView index(User userModel, HttpServletRequest request) {  
	...
	@ResponseBody
	public ModelMap getJsonUserList(User userModel, HttpServletRequest request, HttpServletResponse response) {
